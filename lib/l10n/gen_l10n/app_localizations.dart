...
abstract class AppLocalizations {
  ...
  /// No description provided for @titleInputField.
  ///
  /// In en, this message translates to:
  /// **'Title'**
  String get titleInputField;

  /// No description provided for @amountInputField.
  ///
  /// In en, this message translates to:
  /// **'Amount'**
  String get amountInputField;

  /// No description provided for @typeInputField.
  ///
  /// In en, this message translates to:
  /// **'Type'**
  String get typeInputField;

  /// No description provided for @dateInputField.
  ///
  /// In en, this message translates to:
  /// **'Select Date'**
  String get dateInputField;
